...
namespace ArcGISMapViewer.Views
{
    ...
    /// </summary>
    public sealed partial class FeatureFormPage : Page
    {
        public FeatureFormPage()
        {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (e.Parameter is GeoElement element)
            {
                GeoElement = element;
            }
        }
        ...
        public static readonly DependencyProperty GeoElementProperty =
            DependencyProperty.Register(nameof(GeoElement), typeof(GeoElement), typeof(FeatureFormPage), new PropertyMetadata(null, (s,e) => ((FeatureFormPage)s).GeoElementPropertyChanged(e.OldValue as GeoElement, e.NewValue as GeoElement)));
        ...
        public static readonly DependencyProperty FeatureFormProperty =
            DependencyProperty.Register(nameof(FeatureForm), typeof(FeatureForm), typeof(FeatureFormPage), new PropertyMetadata(null, (s, e) => ((FeatureFormPage)s).OnFeatureFormPropertyChanged()));

        private void OnFeatureFormPropertyChanged()
        {
            if (FeatureForm is null && Frame.CanGoBack)
                Frame.GoBack();
        }
